...
import com.nishant.moviescollection.ui.component.SearchBar
...
@Composable
fun SearchResult(searchResult: State<Result<BaseModel>>, onMovieClicked: (id: Int) -> Unit) {
    Box(contentAlignment = Alignment.Center, modifier = Modifier.fillMaxSize()){
        when (searchResult.value) {
            ...
            is Result.Success -> {
                val list = (searchResult.value as Result.Success<BaseModel>).t
