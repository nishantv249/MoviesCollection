...
interface MoviesApiService {
    ...
    suspend fun search(
        @Query("query") searchKey: String, @Query("api_key") api_key: String = API_KEY
    ): MoviesDto

    @GET("genre/movie/list")
    suspend fun genreList(@Query("api_key") api_key: String = API_KEY): GenresDto
    ...
    suspend fun movieDetail(
        @Path("movieId") movieId: Int, @Query("api_key") api_key: String = API_KEY
    ): MovieDetailDto
    ...
    suspend fun artistDetail(
        @Path("personId") personId: Int, @Query("api_key") api_key: String = API_KEY
    ): ArtistDetailDto
